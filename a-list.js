...
// A common data structure is the list (not to be confused with array). A list is a nested set of 
// objects, with the first object holding a reference to the second, the second to the third, and so on.
